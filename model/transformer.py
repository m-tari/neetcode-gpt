...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.multi_head_attention = MultiHeadedSelfAttention(model_dim, num_heads)
        self.vanilla_neural_network = VanillaNeuralNetwork(model_dim)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        x = x + self.vanilla_neural_network(self.layer_norm_2(x))
